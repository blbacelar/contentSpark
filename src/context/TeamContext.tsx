    ...
    const loadTeams = async () => {
        ...
        try {
            ...
            if (data.length === 0 && !creatingDefaultRef.current) {
                ...
                try {
                    debugLog('No teams found, creating default team...');
            ...
            setTeams(data);
            debugLog('DEBUG: loadTeams data:', data, 'LastID:', localStorage.getItem('CS_LAST_TEAM_ID'));
            ...
            if (!isInitialized.current && !currentTeam && data.length > 0) {
                ...
                debugLog('DEBUG: Auto-selecting team:', targetTeam);
